// ==UserScript==
// @name       		TP+ Browncoat's TagPro Mod
// @version    		2.0.1
...
tagpro.ready(function () {
    ...
    var drawDropShadows = true;
    var dropShadowUrl = "http://i.imgur.com/0q3VhuI.png";
    ...
    tagpro.ui.scores = function () {
        ...
        if (tagpro.ui.sprites.redScore) {
            tagpro.ui.sprites.redScore.text != n && (tagpro.ui.sprites.redScore.text=n);
            tagpro.ui.sprites.blueScore.text != r && (tagpro.ui.sprites.blueScore.text=r);
        } else {
            ...
            tagpro.ui.sprites.redScore = new PIXI.Text(n, {fill: redColorHex, stroke: redStroke, strokeThickness: 2, fontFamily: "Arial", fontsize: "40pt", fontWeight: "bold"});
            tagpro.ui.sprites.blueScore = new PIXI.Text(r, {fill: blueColorHex, stroke: blueStroke, strokeThickness: 2, fontFamily: "Arial", fontsize: "40pt", fontWeight: "bold"});
    ...
    // https://github.com/pixijs/pixi-particles-editor
    ...
    function ensureShadowsLayer() {
        if (!tr.layers.shadowLayer) {
            tr.layers.shadowLayer = new PIXI.Container();
